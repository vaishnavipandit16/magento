...
$table = $installer->getConnection()
    ->newTable('competitor_eav_attribute')
    ...
    ->addColumn('frontend_input_rendered', Varien_Db_Ddl_Table::TYPE_TEXT, null, array(
    ), 'Frontend Input Rendered')
...
$setup->addAttribute(Ccc_Competitor_Model_Resource_Competitor::ENTITY, 'firstname', array(
'type' => 'varchar',
'backend' => '',
'frontend' => '',
'label' => 'firstname',
'input' => 'text',
'global' => Ccc_Competitor_Model_Resource_Eav_Attribute::SCOPE_STORE,
'visible' => 1,
'required' => 0,
'user_defined' => 1,
'searchable' => 1,
...
'comparable' => 1,
'visible_on_front' => 1,
'visible_in_advance_search' => 0,
'is_html_Allowrd_on_front' => 1,
'group' => 'General'
));

$installer->addAttribute(Ccc_Competitor_Model_Resource_Competitor::ENTITY, 'lastname', array(
'type' => 'varchar',
'backend' => '',
'frontend' => '',
'label' => 'lastname',
