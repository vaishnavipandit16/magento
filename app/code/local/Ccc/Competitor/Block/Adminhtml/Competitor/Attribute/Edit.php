...
class Ccc_Competitor_Block_Adminhtml_Competitor_Attribute_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        if($this->getRequest()->getParam('popup')) {
            ...
            $this->_addButton(
                'close',
                array(
                    'label'     => Mage::helper('competitor')->__('Close Window'),
                    'class'     => 'cancel',
    ...
    public function getHeaderText()
    {
        if (Mage::registry('entity_attribute')->getId()) {
            ...
            return Mage::helper('competitor')->__('Edit Competitor Attribute "%s"', $this->escapeHtml($frontendLabel));
        }
        else {
            return Mage::helper('competitor')->__('New Competitor Attribute');
        }
    }
